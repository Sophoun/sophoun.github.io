...
const Resume = () => (
	<Layout>
			...
			<div className="d-flex justify-content-center">
				...
				<div className="ml-5">
					...
					<p className="paragraph3">
						Professional mobile and backend developer with 7 years experience
						that already solve many problems for customers over the world.
					</p>
				</div>
			</div>
		</div>
		<div style={{ marginTop: "50px" }}>
			...
			<hr className="break-line" />
			<p>
				Analytical and detail oriented Android app developer professional with
				stellar communication skills. Adept at bringing all team members
				together to reach a common goal on time. Conceptualizing app solutions
				with the latest technology, design theory, and a large dose of
				creativity. Committed to viable and easily functional app solutions for
				clients.
			</p>
		</div>
		<div>
			...
			<Timeline lineColor={"#ddd"} className="timeline-custom">
				...
				>
					...
					<p>
						<ul>
							...
							<li>
								Independent developer that handles 3 or 4 projects at the same
								time
							</li>
						</ul>
					</p>
				...
				>
					...
					<p>
						<ul>
							<li>
								Provided onside support to customer who had trouble with their
								POS system and also redesign their report using Crystal Report
							</li>
			...
			<Timeline lineColor={"#ddd"} className="timeline-custom">
				...
				>
					<h3 style={{ color: "#61b8ff" }}>
						Cambodia Korean Cooperation Center, CKCC
					</h3>
					<p>Certified Associate Android Development</p>
				</TimelineItem>
				<TimelineItem
					key="004"
				...
				>
					...
					<p>Certified associate web development</p>
				</TimelineItem>
			</Timeline>
			<Footer />
		</div>
